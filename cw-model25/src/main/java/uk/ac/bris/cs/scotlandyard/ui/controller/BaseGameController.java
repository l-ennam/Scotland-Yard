...
abstract class BaseGameController<M extends MapController> implements Controller {
	...
	BaseGameController(ResourceManager manager,
					   Stage stage,
					   BoardViewProperty property,
					   EasyBind.TriFunction<ResourceManager,
		...
		this.map = mapSupplier.apply(manager, notifications, property);
